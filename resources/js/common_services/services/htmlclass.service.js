...
const HtmlClass = {
  ...
  initThemes() {
    if (objectPath.get(this.config, "header.self.theme")) {
      ...
      import(`../../../sass/themes/layout/header/base/${theme}.scss`);
    }
